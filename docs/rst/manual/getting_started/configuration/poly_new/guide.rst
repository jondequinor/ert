...
To understand the basics of how to configure and use ERT, we will walk through how to set up a simple project that uses a simple polynomial evaluation as the forward model.
